...
import { useEmbedHostLocalFolder, useHtmlFileSystemProvider } from './setup.common'
...
import './features/cppBlocklyPreview.workbench'
...
// void getApi().then(async (vscode) => {
  // if (!useHtmlFileSystemProvider && !useEmbedHostLocalFolder) {
